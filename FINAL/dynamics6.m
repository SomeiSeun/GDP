% Tanmay Ubgade, 6 d.o.f. Re-entry model with rotating Earth

function dy = dynamics6(t, y)
...
% calculating gravity
g = 9.81*(RE/(RE+h))^2; % m/s^2, acceleration due to gravity
